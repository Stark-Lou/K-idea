 ...
 */
package whu.ts.math.representation;

import org.apache.commons.math3.exception.DimensionMismatchException;
import whu.ts.math.distribution.DistributionDivider;
import whu.ts.math.distribution.NormalDistributionDivider;
import whu.ts.math.normalization.Normalizer;
import whu.ts.math.normalization.ZNormalizer;
import whu.ts.math.type.SaxPair;
